            ...
            <div className="mb-8 lg:mb-0">
              ...
              <form className="space-y-6">
                ...
                <div>
                  <button
                    type="submit"
                    className="w-full bg-gradient-to-r from-blue-500 to-purple-600 hover:from-blue-600 hover:to-purple-700 text-white py-3 px-6 rounded-md font-medium transition duration-300 transform hover:scale-105"
                  >
                    Send Message
                  </button>
                </div>
                ...
                <div className="space-y-4">
                  <div className="flex items-start">
                    ...
                    <div className="ml-3">
                      ...
                      <p className="text-gray-600">(+91) 7021235201</p>
                    </div>
                  </div>
                  <div className="flex items-start">
                    <div className="flex-shrink-0">
                    ...
                    <div className="ml-3">
                      ...
                      <p className="text-gray-600">s.abhishek9090.com</p>
                    </div>
                  </div>
                  <div className="flex items-start">
                    <div className="flex-shrink-0">
                    ...
                    <div className="ml-3">
                      ...
                      <p className="text-gray-600">1315 Kohojgaon, Ambernath-421501</p>
                    </div>
                  </div>
                </div>
              </div>
